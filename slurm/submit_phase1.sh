#!/usr/bin/env bash
# =============================================================================
# submit_phase1.sh — Submit phase1.sh with log paths from .env
#
# Usage:
#   bash slurm/submit_phase1.sh [extra sbatch args]
#
...
JOB_ID=$(sbatch --parsable \
    ...
    "${SCRIPT_DIR}/phase1.sh" \
    "$@")

echo "  Job ID: ${JOB_ID}"
echo "  stdout: ${LOG_DIR}/phase1_${JOB_ID}.out"
echo "  stderr: ${LOG_DIR}/phase1_${JOB_ID}.err"
